...
const Content1 = `
  <section class="grid grid-cols-2 justify-between mt-20 mb-8">
    <h2 class="element-reveal-slide-up text-[#58254e] text-4xl pr-20">Your Trusted Partner In Real Estate</h2>
    <p class="text-[#58254e] pl-5">From buying and selling to property development, we deliver, unparalleled service and results.</p>
  </section>

  <section class="content-1 h-[414px] grid grid-rows-2 grid-cols-4 grid-flow-col gap-1">
    <div class="element-reveal flex row-span-2 col-span-2 bg-[#2c1327] text-white rounded-xl p-5">
    ...
    <div class="element-reveal col-span-2 flex items-center justify-center bg-[#58254e] text-white font-bold text-center rounded-xl p-5">
    ...
    <div class="element-reveal col-span-1 flex flex-col justify-center bg-[#2c1327] text-white font-bold text-center rounded-xl p-5">
      <p class="text-[80px]">150+</p>
      <p class="text-[40px] pb-5">Properties</p>
    </div>
    <div class="element-reveal col-span-1 h-full bg-[#f1f0ee] text-[#2c1327] text-center rounded-xl overflow-hidden">
