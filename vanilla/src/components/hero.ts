...
const Hero = `
  <section class="col-span-12 grid grid-cols-12 gap-1 md:min-h-[545px]">
    <div class="flex flex-col justify-start md:justify-end col-span-12 md:col-span-6">
      <h1 class="text-reveal-stagger relative z-10 text-[#2c1327] font-bold bg-white rounded-3xl mb-11 md:mb-36 py-6">
        Experience Unrivaled Real Estate Excellence
      </h1>
      <a href="/" class="text-[#2c1327] bg-[#f1f0ee] rounded-full px-6 py-4 inline-flex items-center self-center md:self-auto w-fit hover:bg-[#e4e2df] transition ease-in-out duration-500">
